...
import (
	...
	"github.com/rrodero83/learning-go-by-examples/go-rest-api/pkg/swagger/server/restapi"

	"github.com/rrodero83/learning-go-by-examples/go-rest-api/pkg/swagger/server/restapi/operations"
)
...
func GetGopherByName(gopher operations.GetGopherNameParams) middleware.Responder {
	...
	if gopher.Name != "" {
		...
		//by default we return df who gopher
